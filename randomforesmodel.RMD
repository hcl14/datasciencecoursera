...
The visible artifact is **"#DIV/0!"** which is an Excel error; also **cvtd_timestamp** variable is being read as factor which has no sense; it can be claimed obsolete as we have raw timestamps.
...
```{r}
my_pml_testing <- read.csv("pml-testing.csv",na.strings=c("NA","NaN", " ","",'""','"#DIV/0!"','#DIV/0!'),dec="." )
